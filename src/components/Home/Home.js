...
import Resume from "../../AASHIR_SIDDIQUI_RESUME.docx"
...
function Home()
{
    ...
    useEffect(() =>
    {
        ...
        gsap.fromTo(".about-me", { opacity: 0 }, {
            opacity: 1, duration: 1, ease: "power3.inOut", scrollTrigger: {
                trigger: el
            }
        })

        gsap.fromTo(".skills-section", { opacity: 0, x: -200 }, {
            opacity: 1, duration: 1, ease: "expo.out", x: 0, scrollTrigger: {
                trigger: skill,
            }
        })

        gsap.fromTo(".experience-section", { opacity: 0, y: 200 }, {
            opacity: 1, duration: 2, ease: "expo.out", y: 0, scrollTrigger: {
                trigger: experience,
            }
        })
        ...
        <React.Fragment>
            ...
            <section className='contact-section' id='contact-me'>
                ...
                <div className='contact-con'>
                    ...
                    <a href={Resume} download="AASHIR_SIDDIQUI_Resume.docx"><RetroButton name="Download My Resume"></RetroButton></a>
